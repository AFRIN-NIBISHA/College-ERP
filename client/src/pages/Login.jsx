...
import { User, Lock, ArrowRight, GraduationCap, ShieldCheck, ChevronRight } from 'lucide-react';
import logo from '../assets/dmi_logo.png';

const Login = () => {
    const [role, setRole] = useState('student');
    const [staffRole, setStaffRole] = useState('staff');
    const [studentData, setStudentData] = useState({ name: '', roll_no: '', year: '1', section: 'A' });
