...
const Sidebar = ({ isOpen, onClose }) => {
    ...
    const menus = {
        ...
        admin: [
            ...
            { icon: BookOpen, label: 'Subjects', path: '/subjects' },
            { icon: FileText, label: 'Timetable', path: '/timetable' },
            { icon: ClipboardCheck, label: 'Student Attendance', path: '/attendance/report' },
            { icon: ClipboardCheck, label: 'Faculty Attendance', path: '/attendance/faculty' },
            { icon: BookOpen, label: 'Internal Marks', path: '/marks' },
            { icon: IndianRupee, label: 'Fees Management', path: '/fees' },
            { icon: CheckCircle, label: 'No Due Approval', path: '/no-due' },
            ...
            { icon: Book, label: 'Library Mgmt', path: '/library' },
            { icon: Settings, label: 'Bus Management', path: '/bus-management' },
            { icon: MapPin, label: 'Upload Route (Driver)', path: '/driver-route' },
    ...
    return (
        <aside className={`
            fixed inset-y-0 left-0 z-50 w-72 bg-white lg:bg-white/90 backdrop-blur-xl border-r border-slate-200/60 flex flex-col transition-transform duration-300 ease-in-out shadow-2xl lg:shadow-none
